/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a2ba530ef96a2cb77616dddd9a56b3a1)
// Runtime types generated with workerd@1.20260609.1 2025-01-26
interface __BaseEnv_Env {
  ASSETS: Fetcher;
  SIGNALING_MINER_HISTORY: DurableObjectNamespace<
    import("./src/worker").SignalingMinerHistory
  >;
  BIP110_VIOLATIONS: DurableObjectNamespace<
    import("./src/worker").Bip110ViolationStore
  >;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/worker");
    durableNamespaces: "SignalingMinerHistory" | "Bip110ViolationStore";
  }
